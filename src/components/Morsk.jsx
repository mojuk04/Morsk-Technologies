    ...
    <section className="morsk-section">
      <div className="flex-container">
        <div className="card card1 ">
          ...
          Morsk Technologies offer a complete suite of services in one place. No
          more juggling multiple contracts, project managers and different
        ...
        <div className="card card2">
          ...
          digital experience and provide actionable insights to inform your next
          decisions Our talented experts make sure your experience with us is
          streamlined to your needs and hassle free
        </div>
